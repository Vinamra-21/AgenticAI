...
# **Task**: Given a search term, search the web and produce a concise, high-quality summary.
...
#     model=mimo_model,
#     # input_guardrails=[validate_research_input],  # Disabled when tool is commented
# )
