...
6. Notifications: Push notifications via Pushover
7. LLM Tools: Summarization, translation, code generation
"""
...
async def other_tools():
    ...
    return file_tools + [push_tool, tool_search, python_repl, wiki_tool, tavily_tool]
